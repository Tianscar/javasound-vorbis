...
only a starting point.  There's no point on a machine with an FPU */
	...
	private static void mdct_butterfly_first(final float[] T, final float[] x, int offset, final int points) {
	...
	private static void mdct_butterfly_generic(final float[] T, final float[] x, int offset,
