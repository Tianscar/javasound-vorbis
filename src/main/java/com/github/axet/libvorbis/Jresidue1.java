...
class Jresidue1 extends Jresidue0 implements Iencodepart {
	...
	public final int decodepart(final Jcodebook book, final float[] a, final int offset, final Joggpack_buffer b, int n) {
...
//#endif
	public final int encodepart(final Joggpack_buffer opb,
					final int[] vec, final int offset, final int n, final Jcodebook book) {//, final int[] acc) {
		int bits = 0;
		final int dim = book.dim;
...
/* if( TRAIN_RES ) {
	...
	private static int[][] _01class(final Jvorbis_block vb, final Object vl, final int[][] in, final int ch) {
...
/* if( TRAIN_RESAUX ) {
	...
	int[][] fclass(final Jvorbis_block vb, final Jvorbis_look_residue vl,
	...
	static final int _01forward(final Joggpack_buffer opb,
						final Object vl,
...
//#endif
	...
	int forward(final Joggpack_buffer opb, final Jvorbis_block vb, final Jvorbis_look_residue vl,
...
//#endif
	...
	@Override
	int inverse(final Jvorbis_block vb, final Jvorbis_look_residue vl,
