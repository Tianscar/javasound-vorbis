...
/* #if defined(TRAIN_RES) || defined(TRAIN_RESAUX)
	...
	@Override
	public int decodepart(final Jcodebook book, final float[] a, final int offset, final Joggpack_buffer b, int n) {
...
/* if( TRAIN_RES || TRAIN_RESAUX ) {
	...
	@Override
	int forward(final Joggpack_buffer opb, final Jvorbis_block vb,
				final Jvorbis_look_residue vl, final int[][] in, final boolean[] nonzero, final int ch,
